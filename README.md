...
This is an educational hackathon prototype only. It uses fake W-2 data, performs a bounded 2025 federal W-2-only calculation, and does not provide tax advice, e-file, or handle real PII. The PDF template is the IRS Form 1040 downloaded from `https://www.irs.gov/pub/irs-pdf/f1040.pdf`.
